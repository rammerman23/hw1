...
Insert into people (id, real_name, role)
VALUES ("1", "Christian Bale", "Batman"),
...
("8", "Tom Hardy", "Bane"),
("9", "Joseph Gordon-Levitt", "John Blake"),
("10", "Anne Hathaway", "Seline Kyle");
...
SELECT movies.title, FROM movies INNER JOIN people on people.real_name = 